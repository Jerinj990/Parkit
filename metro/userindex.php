            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="ml-auto">
                            <a class="btn btn-custom" href='myprofile.php'>My profile</a>
                ...
                <div class="owl-carousel">
                    <div class="carousel-item">
                        ...
                        <div class="carousel-text">
                            <h3>Park your car</h3>
                            <h1>Park your car safely&smoothly</h1>
                            <p>
                                speed up your car parking just in click
                            </p>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-text">
                            ...
                            <p>
                                Get your car cleaned after your meeting
                            </p>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-text">
                            ...
                            <h1>All type of services </h1>
                            <p>
                                Service and maintain your car and make it like brand new
                            </p>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="about-content">
                            <p>
                                Park it provides a user to speed up the car parking process and it improves the parking areas management also we provide services like
                            </p>
                            <ul>
                                <li><i class="far fa-check-circle"></i>washing</li>
                                <li><i class="far fa-check-circle"></i>Detailing</li>
                                <li><i class="far fa-check-circle"></i>Periodic services</li>
        ...
        <!-- Facts End -->
         ...
         <div class="service">
            <div class="container">
                ...
                $qry = "select * from parkingareatable";
                ...
                <div class="col-lg-3 col-md-6">
                        ...
                        <i class="fa fa-map-marker-alt"></i>
                            ...
                            <p>Email: <?php  echo $row['email']; ?>&nbsp;&nbsp;&nbsp;&nbsp;Address:<?php  echo $row['address']; ?></p>
                            <p>Rate: <?php  echo $row['rate']; ?>&nbsp;&nbsp;&nbsp;&nbsp;Additional rate:<?php  echo $row['additionalrate']; ?></p>
                            <p><form name="f" action="service.php" method="post">
                                <input type="hidden" name="place" value="<?php echo $row['parkingplaceno'];?>"/>
