...
session_start();
                               ...
                               //     $subject=$_POST["subject"];
                                    ...
                                    $qry ="INSERT INTO `feedbacktable` (`id`, `user`, `message`, `reply`, `feedback_date`,reply_date) VALUES (NULL, ".$_SESSION['uid'].", '".$message."','--',curdate(),'--')";
                        ...
                        <div class="contact-form">
                            ...
                            <form name="sentMessage" method="post"  novalidate="novalidate">
                              <!--  <div class="control-group">
                                ...
                                <div>
                                    <button class="btn btn-custom" type="submit" name="send">Send Feedback</button>
