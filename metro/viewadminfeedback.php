<?php  session_start();
                         ...
                         if(isset($_POST["sbmt"])){
                            mysqli_query($con,"update feedbacktable set reply='".$_POST['reply']."', reply_date=curdate() where id=".$_POST['id']);
                         }
                         ?><!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <div class="container">
                ...
                <div class="row">
                    <table width="100%">
                        ...
                        $qry="SELECT f.*,u.name,u.email,u.mobile FROM feedbacktable as f join usertable as u on f.user=u.id "; 
                       ...
                       <tr>
                        ...
                        <?php if($row['reply_date']!='--'){
                            echo $row['reply']."<br/>On: ".$row['reply_date'];
                        }                        
                        else{
                            ?>
                            <form name="gf" action="viewadminfeedback.php" method="post">
                                <input type="text" name="reply" placeholder="Reply"/>
                                <input type="hidden" name="id" value="<?php echo $row['id'];?>"/>
                                <input type="submit" name="sbmt" value="Reply Now"/>
                            </form>
                            <?php
                        }?>
                        </td>
